...
By itself, it does nothing. But when you plug modules into it, it opens a whole world for you to explore. See below for the different modules you can put in. This will be an ongoing project to make many aspects of Starbound modding much simpler and easier, by simply allowing you to click a button to update files.
