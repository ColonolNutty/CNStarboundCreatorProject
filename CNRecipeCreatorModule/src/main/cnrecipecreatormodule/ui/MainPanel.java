...
public class MainPanel implements IMainFunctionPanel {
    ...
    public JPanel create() {
        ...
        ConfigReader<RecipeCreatorSettings> reader = new ConfigReader<RecipeCreatorSettings>(tempLog);
        ICRData<RecipeCreatorSettings> crData = new RecipeCreatorCRData();
        _settings = reader.readSettingsFile(crData, RecipeCreatorSettings.class);
        tempLog.dispose();
